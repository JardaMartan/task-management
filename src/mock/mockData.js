  ...
  voice: {
    calls: [
      { id: 'call-1', taskId: 'task-2024-0892-voice-2', active: true,  customer: 'Sarah Johnson', phone: '+44 20 7946 0958', started: '09:41',     durationSec: 847, direction: 'inbound',  queue: 'Priority Banking', caseId: REF.case1, sentiment: 'negative', outcome: null, outcomeKey: null,
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 58,
          callReason: 'SEPA transfer not credited',
          handOffReason: 'Caller requested a human agent for an urgent overdue business payment',
          details: 'The virtual agent authenticated the caller and identified an outstanding SEPA transfer enquiry. Self-service payment tracking was offered, but the caller requested a live agent because a supplier invoice was already overdue.',
          transcript: [
            { id: 'va1', role: 'bot',    text: "Thank you for calling Moneta Bank. I'm your virtual assistant. To get started, can you tell me what you're calling about today?", time: '00:00' },
            { id: 'va2', role: 'caller', text: "My SEPA transfer hasn't arrived and the invoice is overdue.", time: '00:08' },
            { id: 'va3', role: 'bot',    text: 'I can help with a payment enquiry. I have located a SEPA transfer on your account currently under review. Would you like me to text you the status, or speak to a payments agent?', time: '00:19' },
            { id: 'va4', role: 'caller', text: 'I need to speak to an agent, this is urgent.', time: '00:41' },
            { id: 'va5', role: 'bot',    text: 'No problem. I am connecting you to a Priority Banking payments specialist now.', time: '00:48' },
          ],
        },
      },
      { id: 'call-2', taskId: 'task-2024-0784-voice-1', active: false, customer: 'Sarah Johnson', phone: '+44 20 7946 0958', started: '2025-05-29', durationSec: 312, direction: 'outbound', queue: 'Callback',         caseId: REF.case2, sentiment: 'positive', outcome: 'Resolved', outcomeKey: 'resolved',
        wrapUp: { code: 'CB_RESOLVED', reason: 'Callback – Query Resolved', note: 'Returned customer callback about the login / 2FA fix. Confirmed account access restored; no further action required.', duration: 25 },
      },
      { id: 'call-3', taskId: 'task-2024-0651-voice-1', active: false, customer: 'Sarah Johnson', phone: '+44 20 7946 0958', started: '2025-04-14', durationSec: 489, direction: 'inbound',  queue: 'General Banking',  caseId: REF.case3, sentiment: 'neutral',  outcome: 'Transferred', outcomeKey: 'transferred',
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 40,
          callReason: 'Overdraft fee query',
          handOffReason: 'Fee dispute required manual review by a banking agent',
          details: 'The virtual agent identified an overdraft fee dispute and routed the caller to General Banking after self-service could not waive the fee.',
          transcript: [
            { id: 'va1', role: 'bot',    text: 'Thanks for calling Moneta Bank. How can I help you today?', time: '00:00' },
            { id: 'va2', role: 'caller', text: 'I want to query a £45 overdraft fee.', time: '00:06' },
            { id: 'va3', role: 'bot',    text: "I can see an overdraft fee applied on 8 May. I'm not able to waive fees automatically, so I'll connect you to a banking agent who can review it.", time: '00:15' },
          ],
        },
        wrapUp: { code: 'FEE_DISPUTE', reason: 'Overdraft Fee – Transferred to Back Office', note: 'Fee dispute logged; evidence of processor delay requested. Transferred to the back-office review team.', duration: 30 },
      },
      { id: 'call-4', taskId: 'task-2024-0445-voice-1', active: false, customer: 'Sarah Johnson', phone: '+44 20 7946 0958', started: '2025-03-01', durationSec: 228, direction: 'inbound',  queue: 'General Banking',  caseId: REF.case4, sentiment: 'positive', outcome: 'Resolved', outcomeKey: 'resolved',
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 72,
          callReason: 'Card blocked abroad',
          handOffReason: 'Caller requested urgent card reactivation while travelling',
          details: 'The virtual agent detected a fraud-related card block during international travel and escalated to the Fraud & Security team for identity verification and reactivation.',
          transcript: [
            { id: 'va1', role: 'bot',    text: "Welcome to Moneta Bank. I'm the virtual assistant. What can I help you with?", time: '00:00' },
            { id: 'va2', role: 'caller', text: "My card was blocked, I'm in New York and can't pay for anything.", time: '00:07' },
            { id: 'va3', role: 'bot',    text: 'I can see a security block was placed on your card during international use. For your protection I will transfer you to our Fraud & Security team to verify your identity and reactivate it.', time: '00:18' },
            { id: 'va4', role: 'caller', text: 'Yes please, hurry.', time: '00:33' },
          ],
        },
        wrapUp: { code: 'CARD_REACT', reason: 'Card Reactivated – Travel Auth', note: 'Identity verified via video call. Card reactivated for US travel; 14-day travel notice added. Customer satisfied.', duration: 40 },
      },
    ],
    transcript: [
  ...
  history: {
    ...
    interactionSummaries: {
      'task-2024-0892-voice-2': {
        ...
        virtualAgent: { callReason: 'SEPA transfer follow-up', handOffReason: 'Caller requested a payments agent to chase an escalated transfer', containmentSec: 45 },
        wrapUp: { code: 'PAYMENT_ESC', reason: 'Payment Escalation – Resolved', note: 'Escalated the SEPA compliance hold to the Senior Payments Officer with a 2-hour callback commitment. Customer notified by SMS.' },
      },
      'task-2024-0445-voice-1': {
        ...
        virtualAgent: { callReason: 'Card blocked abroad', handOffReason: 'Caller requested urgent reactivation while travelling in the USA', containmentSec: 90 },
        wrapUp: { code: 'CARD_REACT', reason: 'Card Reactivated – Travel Auth', note: 'Card reactivated within 20 minutes after video identity verification. Travel notice added for the US trip.' },
      },
    },
  ...
  voice: {
    calls: [
      { id: 'call-1', taskId: 'task-2024-0892-voice-2', active: true,  customer: 'Anna Müller', phone: '+49 89 1234 5678', started: '09:41',     durationSec: 847, direction: 'inbound',  queue: 'Priority Banking',       caseId: REF.case1, sentiment: 'negative', outcome: null, outcomeKey: null,
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 58,
          callReason: 'SEPA-Überweisung nicht gutgeschrieben',
          handOffReason: 'Anruferin bat um einen menschlichen Agenten für eine dringende überfällige Geschäftszahlung',
          details: 'Der virtuelle Agent authentifizierte die Anruferin und identifizierte eine offene SEPA-Überweisungsanfrage. Self-Service-Zahlungsverfolgung wurde angeboten, doch die Anruferin wollte einen Live-Agenten, da eine Lieferantenrechnung bereits überfällig war.',
          transcript: [
            { id: 'va1', role: 'bot',    text: 'Danke für Ihren Anruf bei der Moneta Bank. Ich bin Ihr virtueller Assistent. Womit kann ich Ihnen heute helfen?', time: '00:00' },
            { id: 'va2', role: 'caller', text: 'Meine SEPA-Überweisung ist nicht angekommen und die Rechnung ist überfällig.', time: '00:08' },
            { id: 'va3', role: 'bot',    text: 'Ich kann bei einer Zahlungsanfrage helfen. Ich habe eine SEPA-Überweisung auf Ihrem Konto gefunden, die derzeit geprüft wird. Soll ich Ihnen den Status per SMS senden oder Sie mit einem Zahlungs-Agenten verbinden?', time: '00:19' },
            { id: 'va4', role: 'caller', text: 'Ich muss mit einem Agenten sprechen, es ist dringend.', time: '00:41' },
            { id: 'va5', role: 'bot',    text: 'Kein Problem. Ich verbinde Sie jetzt mit einem Priority-Banking-Zahlungsspezialisten.', time: '00:48' },
          ],
        },
      },
      { id: 'call-2', taskId: 'task-2024-0784-voice-1', active: false, customer: 'Anna Müller', phone: '+49 89 1234 5678', started: '2025-05-29', durationSec: 312, direction: 'outbound', queue: 'Rückruf',                caseId: REF.case2, sentiment: 'positive', outcome: 'Gelöst', outcomeKey: 'resolved',
        wrapUp: { code: 'CB_RESOLVED', reason: 'Rückruf – Anfrage gelöst', note: 'Kundenrückruf zum Login-/2FA-Fix erledigt. Kontozugriff wiederhergestellt bestätigt; kein weiterer Handlungsbedarf.', duration: 25 },
      },
      { id: 'call-3', taskId: 'task-2024-0651-voice-1', active: false, customer: 'Anna Müller', phone: '+49 89 1234 5678', started: '2025-04-14', durationSec: 489, direction: 'inbound',  queue: 'Allgemeines Banking',    caseId: REF.case3, sentiment: 'neutral',  outcome: 'Weitergeleitet', outcomeKey: 'transferred',
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 40,
          callReason: 'Anfrage zu Überziehungsgebühr',
          handOffReason: 'Gebührenstreit erforderte manuelle Prüfung durch einen Banking-Agenten',
          details: 'Der virtuelle Agent identifizierte einen Überziehungsgebühren-Streit und leitete die Anruferin an das Allgemeine Banking weiter, da der Self-Service die Gebühr nicht erlassen konnte.',
          transcript: [
            { id: 'va1', role: 'bot',    text: 'Danke für Ihren Anruf bei der Moneta Bank. Wie kann ich Ihnen heute helfen?', time: '00:00' },
            { id: 'va2', role: 'caller', text: 'Ich möchte eine Überziehungsgebühr von 45 € reklamieren.', time: '00:06' },
            { id: 'va3', role: 'bot',    text: 'Ich sehe eine am 8. Mai erhobene Überziehungsgebühr. Ich kann Gebühren nicht automatisch erlassen, daher verbinde ich Sie mit einem Banking-Agenten, der das prüfen kann.', time: '00:15' },
          ],
        },
        wrapUp: { code: 'FEE_DISPUTE', reason: 'Überziehungsgebühr – an Backoffice weitergeleitet', note: 'Gebührenstreit erfasst; Nachweis der Abwicklungsverzögerung angefordert. An das Backoffice-Prüfteam weitergeleitet.', duration: 30 },
      },
      { id: 'call-4', taskId: 'task-2024-0445-voice-1', active: false, customer: 'Anna Müller', phone: '+49 89 1234 5678', started: '2025-03-01', durationSec: 228, direction: 'inbound',  queue: 'Allgemeines Banking',    caseId: REF.case4, sentiment: 'positive', outcome: 'Gelöst', outcomeKey: 'resolved',
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 72,
          callReason: 'Karte im Ausland gesperrt',
          handOffReason: 'Anruferin bat um dringende Kartenreaktivierung während einer Reise',
          details: 'Der virtuelle Agent erkannte eine betrugsbedingte Kartensperre während einer Auslandsreise und eskalierte an das Team Betrug & Sicherheit zur Identitätsprüfung und Reaktivierung.',
          transcript: [
            { id: 'va1', role: 'bot',    text: 'Willkommen bei der Moneta Bank. Ich bin der virtuelle Assistent. Womit kann ich Ihnen helfen?', time: '00:00' },
            { id: 'va2', role: 'caller', text: 'Meine Karte wurde gesperrt, ich bin in New York und kann nichts bezahlen.', time: '00:07' },
            { id: 'va3', role: 'bot',    text: 'Ich sehe, dass während der Auslandsnutzung eine Sicherheitssperre auf Ihre Karte gesetzt wurde. Zu Ihrem Schutz verbinde ich Sie mit unserem Team Betrug & Sicherheit, um Ihre Identität zu prüfen und die Karte zu reaktivieren.', time: '00:18' },
            { id: 'va4', role: 'caller', text: 'Ja bitte, schnell.', time: '00:33' },
          ],
        },
        wrapUp: { code: 'CARD_REACT', reason: 'Karte reaktiviert – Reise-Auth', note: 'Identität per Video-Call verifiziert. Karte für USA-Reise reaktiviert; 14-Tage-Reisehinweis hinterlegt. Kundin zufrieden.', duration: 40 },
      },
    ],
    transcript: [
  ...
  history: {
    ...
    interactionSummaries: {
      'task-2024-0892-voice-2': {
        ...
        virtualAgent: { callReason: 'SEPA-Überweisung Nachverfolgung', handOffReason: 'Anruferin bat um einen Zahlungs-Agenten, um eine eskalierte Überweisung zu verfolgen', containmentSec: 45 },
        wrapUp: { code: 'PAYMENT_ESC', reason: 'Zahlungseskalation – Gelöst', note: 'SEPA-Compliance-Sperre an den Senior-Zahlungsbeauftragten eskaliert mit 2-Stunden-Rückrufzusage. Kundin per SMS benachrichtigt.' },
      },
      'task-2024-0445-voice-1': {
        ...
        virtualAgent: { callReason: 'Karte im Ausland gesperrt', handOffReason: 'Anruferin bat um dringende Reaktivierung während einer Reise in den USA', containmentSec: 90 },
        wrapUp: { code: 'CARD_REACT', reason: 'Karte reaktiviert – Reise-Auth', note: 'Karte innerhalb von 20 Minuten nach Video-Identitätsprüfung reaktiviert. Reisehinweis für die USA-Reise hinterlegt.' },
      },
    },
  ...
  voice: {
    calls: [
      { id: 'call-1', taskId: 'task-2024-0892-voice-2', active: true,  customer: 'Jana Nováková', phone: '+420 222 333 444', started: '09:41',     durationSec: 847, direction: 'inbound',  queue: 'Priority Banking',          caseId: REF.case1, sentiment: 'negative', outcome: null, outcomeKey: null,
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 58,
          callReason: 'SEPA platba nepřipsána',
          handOffReason: 'Volající požádala o lidského agenta kvůli urgentní platbě po splatnosti',
          details: 'Virtuální agent ověřil volající a identifikoval nevyřízený dotaz na SEPA platbu. Byla nabídnuta samoobslužná kontrola platby, ale volající požádala o živého agenta, protože faktura dodavatele byla již po splatnosti.',
          transcript: [
            { id: 'va1', role: 'bot',    text: 'Děkujeme, že voláte Moneta Bank. Jsem váš virtuální asistent. S čím vám mohu dnes pomoci?', time: '00:00' },
            { id: 'va2', role: 'caller', text: 'Moje SEPA platba nedorazila a faktura je po splatnosti.', time: '00:08' },
            { id: 'va3', role: 'bot',    text: 'Mohu pomoci s dotazem na platbu. Našel jsem na vašem účtu SEPA platbu, která se právě přezkoumává. Chcete stav zaslat SMS, nebo mluvit s agentem pro platby?', time: '00:19' },
            { id: 'va4', role: 'caller', text: 'Potřebuji mluvit s agentem, je to urgentní.', time: '00:41' },
            { id: 'va5', role: 'bot',    text: 'Žádný problém. Nyní vás spojím se specialistou na platby v Priority Banking.', time: '00:48' },
          ],
        },
      },
      { id: 'call-2', taskId: 'task-2024-0784-voice-1', active: false, customer: 'Jana Nováková', phone: '+420 222 333 444', started: '2025-05-29', durationSec: 312, direction: 'outbound', queue: 'Zpětné volání',             caseId: REF.case2, sentiment: 'positive', outcome: 'Vyřešeno', outcomeKey: 'resolved',
        wrapUp: { code: 'CB_RESOLVED', reason: 'Zpětné volání – dotaz vyřešen', note: 'Vyřízeno zpětné volání zákaznici ohledně opravy přihlášení / 2FA. Potvrzeno obnovení přístupu k účtu; není třeba další akce.', duration: 25 },
      },
      { id: 'call-3', taskId: 'task-2024-0651-voice-1', active: false, customer: 'Jana Nováková', phone: '+420 222 333 444', started: '2025-04-14', durationSec: 489, direction: 'inbound',  queue: 'Obecné bankovnictví',       caseId: REF.case3, sentiment: 'neutral',  outcome: 'Přesměrováno', outcomeKey: 'transferred',
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 40,
          callReason: 'Dotaz na poplatek za přečerpání',
          handOffReason: 'Spor o poplatek vyžadoval ruční přezkoumání bankovním agentem',
          details: 'Virtuální agent identifikoval spor o poplatek za přečerpání a přesměroval volající na Obecné bankovnictví, protože samoobsluha nemohla poplatek prominout.',
          transcript: [
            { id: 'va1', role: 'bot',    text: 'Děkujeme, že voláte Moneta Bank. Jak vám mohu dnes pomoci?', time: '00:00' },
            { id: 'va2', role: 'caller', text: 'Chci reklamovat poplatek za přečerpání 45 €.', time: '00:06' },
            { id: 'va3', role: 'bot',    text: 'Vidím poplatek za přečerpání účtovaný 8. května. Poplatky nemohu prominout automaticky, proto vás spojím s bankovním agentem, který jej může přezkoumat.', time: '00:15' },
          ],
        },
        wrapUp: { code: 'FEE_DISPUTE', reason: 'Poplatek za přečerpání – předáno back office', note: 'Spor o poplatek zaznamenán; vyžádán důkaz o zpoždění zpracovatele. Předáno týmu back-office k přezkoumání.', duration: 30 },
      },
      { id: 'call-4', taskId: 'task-2024-0445-voice-1', active: false, customer: 'Jana Nováková', phone: '+420 222 333 444', started: '2025-03-01', durationSec: 228, direction: 'inbound',  queue: 'Obecné bankovnictví',       caseId: REF.case4, sentiment: 'positive', outcome: 'Vyřešeno',      outcomeKey: 'resolved',
        virtualAgent: {
          provider: 'Cisco AI Assistant', containmentSec: 72,
          callReason: 'Karta zablokována v zahraničí',
          handOffReason: 'Volající požádala o urgentní reaktivaci karty během cestování',
          details: 'Virtuální agent zjistil blokaci karty související s podvodem během zahraniční cesty a eskaloval na tým Podvody a bezpečnost k ověření identity a reaktivaci.',
          transcript: [
            { id: 'va1', role: 'bot',    text: 'Vítejte v Moneta Bank. Jsem virtuální asistent. S čím vám mohu pomoci?', time: '00:00' },
            { id: 'va2', role: 'caller', text: 'Moje karta byla zablokována, jsem v New Yorku a nemůžu za nic zaplatit.', time: '00:07' },
            { id: 'va3', role: 'bot',    text: 'Vidím, že během používání v zahraničí byla na vaši kartu vložena bezpečnostní blokace. Pro vaši ochranu vás přepojím na náš tým Podvody a bezpečnost, aby ověřil vaši identitu a kartu reaktivoval.', time: '00:18' },
            { id: 'va4', role: 'caller', text: 'Ano prosím, pospěšte si.', time: '00:33' },
          ],
        },
        wrapUp: { code: 'CARD_REACT', reason: 'Karta reaktivována – cestovní autorizace', note: 'Identita ověřena přes videohovor. Karta reaktivována pro cestu do USA; přidáno 14denní cestovní upozornění. Zákaznice spokojena.', duration: 40 },
      },
  ...
  history: {
    ...
    interactionSummaries: {
      'task-2024-0892-voice-2': {
        ...
        virtualAgent: { callReason: 'Sledování SEPA převodu', handOffReason: 'Volající požádala o platebního agenta, aby urgoval eskalovaný převod', containmentSec: 45 },
        wrapUp: { code: 'PAYMENT_ESC', reason: 'Eskalace platby – vyřešeno', note: 'SEPA compliance blokace eskalována na senior platebního specialistu se závazkem zpětného volání do 2 hodin. Zákaznice informována SMS.' },
      },
      'task-2024-0445-voice-1': {
        ...
        virtualAgent: { callReason: 'Karta zablokována v zahraničí', handOffReason: 'Volající požádala o urgentní reaktivaci během cesty v USA', containmentSec: 90 },
        wrapUp: { code: 'CARD_REACT', reason: 'Karta reaktivována – cestovní autorizace', note: 'Karta reaktivována do 20 minut po video ověření identity. Přidáno cestovní upozornění pro cestu do USA.' },
      },
    },
