...
const baseDictionary = {
  ...
  customer: {
    ...
    search: {
      ...
      searching: 'Searching…',
      clear: 'Clear search',
      prompt: 'Search for a customer by email or phone number to view their 360° profile.',
      notFound: 'No customer found for “{{identity}}”.',
      error: 'Customer lookup is unavailable right now.',
    },
  },
  case: {
  ...
  settings: {
    ...
    close: 'Close',
    sla: {
      title: 'SLA expiry action',
      emailOnly: 'Applies to email tasks you have not started yet.',
      action: 'When SLA is reached',
      action_none: 'No action',
      action_offer: 'Offer requeue',
      action_auto: 'Auto requeue',
      trigger: 'Trigger',
      trigger_imminent: 'Within threshold',
      trigger_expired: 'After expiration',
      queue: 'Requeue to (email)',
      selectQueue: 'Select a queue…',
      loadingQueues: 'Loading queues…',
      countdown: 'Auto countdown (seconds)',
      wrapup: 'Wrap-up reason (auto-submitted)',
      selectWrapup: 'Select a wrap-up reason…',
    },
    focus: {
      title: 'Focus on priority work',
      hint: 'When an email nears or passes its SLA, set you to Not Available so no new tasks are routed while you finish it. Returns you to Available when the task is done.',
      mode: 'Focus mode',
      on: 'On',
      off: 'Off',
  ...
  sla: {
    requeue: {
      autoCountdown: 'Requeuing to {{queue}} in {{seconds}}s…',
      cancel: 'Keep task',
      offerTitle: 'SLA expiring — requeue this task?',
      offerMsg: 'This task has reached its SLA and you have not started it. Choose a queue to requeue it to.',
      queueLabel: 'Queue',
      selectQueue: 'Select a queue…',
      dismiss: 'Keep task',
      confirm: 'Requeue',
  ...
  focus: {
    active: 'Focus mode: you\'re Not Available ({{reason}}) so you can finish this priority task.',
  ...
  email: {
    ...
    noCustomerEmail: 'No email address on file for this customer.',
    subject: 'Subject',
    from: 'From',
    to: 'To',
    cc: 'CC',
    ...
    reply: {
      ...
      proofread: {
        panelLabel: 'Reply review',
        found: 'Found {n} issue(s)',
        noIssues: 'No grammar issues found',
        applyAll: 'Apply Corrections',
        dismiss: 'Dismiss',
        accept: 'Accept',
        reject: 'Reject',
        inlineCount: '{n} suggestion(s) in text',
        coverage: {
          answers: 'The reply addresses the customer’s message',
          incomplete: 'The reply may not fully answer the customer',
          missingLabel: 'Not addressed',
          additionsLabel: 'Suggested additions',
          add: 'Add to reply',
          added: 'Added',
        },
        type: {
    ...
    wrapupSummary: {
      ...
      generating: 'Generating wrap-up summary…',
      copy: 'Copy',
      copied: 'Copied',
  ...
  history: {
    ...
    aiSummaryReason: 'Reason',
    aiSummaryActions: 'Actions',
    aiSummaryNextSteps: 'Next steps',
    aiSummaryAdditional: 'Additional',
    aiSummaryVaTitle: 'Virtual agent handoff',
    aiSummaryVaCallReason: 'Call reason',
    aiSummaryVaHandoff: 'Handoff reason',
    aiSummaryVaContainment: 'Time in bot',
    aiSummaryWrapUpTitle: 'Wrap-up',
    aiSummaryWrapUpNote: 'Note',
    ...
    dataPanel: {
      ...
      caseDetailsNotAvailable: 'Case details not available in live mode',
    },
    eventType: {
      new: 'New',
  ...
  voice: {
    ...
    transcriptUnavailable: 'No transcript available for this call yet.',
    transcriptLive: 'This call is in progress. The transcript will be available after it ends.',
    callsLoading: 'Loading calls…',
    callsEmpty: 'No calls found for this customer.',
    summaryLoading: 'Loading summary…',
    summaryUnavailable: 'No summary available for this call yet.',
    refresh: 'Refresh transcript',
    live: 'LIVE',
    directionInbound: '↙ Inbound',
    directionOutbound: '↗ Outbound',
    customer: 'Customer',
...
const deDictionary = {
  ...
  customer: {
    ...
    search: {
      placeholder: 'Nach E-Mail oder Telefonnummer suchen',
      button: 'Suchen',
      searching: 'Suche läuft…',
      clear: 'Suche löschen',
      prompt: 'Suchen Sie nach einem Kunden per E-Mail oder Telefonnummer, um sein 360°-Profil anzuzeigen.',
      notFound: 'Kein Kunde für „{{identity}}“ gefunden.',
      error: 'Die Kundensuche ist derzeit nicht verfügbar.',
    },
  },
  case: {
  ...
  settings: {
    ...
    close: 'Schließen',
    sla: {
      title: 'Aktion bei SLA-Ablauf',
      emailOnly: 'Gilt für E-Mail-Aufgaben, die Sie noch nicht begonnen haben.',
      action: 'Wenn SLA erreicht ist',
      action_none: 'Keine Aktion',
      action_offer: 'Rückstellung anbieten',
      action_auto: 'Automatisch rückstellen',
      trigger: 'Auslöser',
      trigger_imminent: 'Innerhalb Schwelle',
      trigger_expired: 'Nach Ablauf',
      queue: 'Rückstellen an (E-Mail)',
      selectQueue: 'Warteschlange wählen…',
      loadingQueues: 'Warteschlangen werden geladen…',
      countdown: 'Auto-Countdown (Sekunden)',
      wrapup: 'Nachbearbeitungsgrund (automatisch)',
      selectWrapup: 'Nachbearbeitungsgrund wählen…',
    },
    focus: {
      title: 'Auf Prioritätsarbeit konzentrieren',
      hint: 'Wenn eine E-Mail ihr SLA erreicht oder überschreitet, werden Sie auf Nicht verfügbar gesetzt, damit keine neuen Aufgaben zugewiesen werden, während Sie diese abschließen. Danach werden Sie wieder auf Verfügbar gesetzt.',
      mode: 'Fokusmodus',
      on: 'Ein',
      off: 'Aus',
  ...
  sla: {
    requeue: {
      autoCountdown: 'Rückstellung an {{queue}} in {{seconds}}s…',
      cancel: 'Aufgabe behalten',
      offerTitle: 'SLA läuft ab — Aufgabe rückstellen?',
      offerMsg: 'Diese Aufgabe hat ihr SLA erreicht und Sie haben sie nicht begonnen. Wählen Sie eine Warteschlange zur Rückstellung.',
      queueLabel: 'Warteschlange',
      selectQueue: 'Warteschlange wählen…',
      dismiss: 'Aufgabe behalten',
      confirm: 'Rückstellen',
    },
  },
  focus: {
    active: 'Fokusmodus: Sie sind Nicht verfügbar ({{reason}}), damit Sie diese Prioritätsaufgabe abschließen können.',
  ...
  email: {
    ...
    noCustomerEmail: 'Für diesen Kunden ist keine E-Mail-Adresse hinterlegt.',
    subject: 'Betreff',
    from: 'Von',
    to: 'An',
    cc: 'CC',
    ...
    reply: {
      ...
      proofread: {
        panelLabel: 'Antwortprüfung',
        found: '{n} Problem(e) gefunden',
        noIssues: 'Keine Grammatikprobleme gefunden',
        applyAll: 'Korrekturen übernehmen',
        dismiss: 'Schließen',
        accept: 'Übernehmen',
        reject: 'Verwerfen',
        inlineCount: '{n} Vorschlag/Vorschläge im Text',
        coverage: {
          answers: 'Die Antwort geht auf die Nachricht des Kunden ein',
          incomplete: 'Die Antwort beantwortet den Kunden möglicherweise nicht vollständig',
          missingLabel: 'Nicht behandelt',
          additionsLabel: 'Vorgeschlagene Ergänzungen',
          add: 'In Antwort einfügen',
          added: 'Hinzugefügt',
        },
        type: {
          grammar: 'Grammatik',
  ...
  history: {
    ...
    aiSummaryReason: 'Grund',
    aiSummaryActions: 'Maßnahmen',
    aiSummaryNextSteps: 'Nächste Schritte',
    aiSummaryAdditional: 'Zusätzlich',
    aiSummaryVaTitle: 'Virtueller Agent – Übergabe',
    aiSummaryVaCallReason: 'Anrufgrund',
    aiSummaryVaHandoff: 'Übergabegrund',
    aiSummaryVaContainment: 'Zeit im Bot',
    aiSummaryWrapUpTitle: 'Nachbearbeitung',
    aiSummaryWrapUpNote: 'Notiz',
    ...
    biz: {
      ...
      outcome: 'Ergebnis',
      endReason: 'Endgrund',
      terminationType: 'Beendigung',
      csat: 'CSAT',
      sentiment: 'Stimmung',
    },
    dataPanel: {
      details: 'Details',
      rawFields: 'Rohdatenfelder',
      caseDetailsNotAvailable: 'Falldetails nicht verfügbar im Live-Modus',
    },
    eventType: {
      new: 'Neu',
      connecting: 'Verbinde',
  ...
  voice: {
    ...
    transcriptUnavailable: 'Für diesen Anruf ist noch kein Transkript verfügbar.',
    transcriptLive: 'Dieser Anruf läuft noch. Das Transkript ist nach dem Ende verfügbar.',
    callsLoading: 'Anrufe werden geladen…',
    callsEmpty: 'Keine Anrufe für diesen Kunden gefunden.',
    summaryLoading: 'Zusammenfassung wird geladen…',
    summaryUnavailable: 'Für diesen Anruf ist noch keine Zusammenfassung verfügbar.',
    refresh: 'Transkript aktualisieren',
    live: 'LIVE',
    directionInbound: '↙ Eingehend',
    directionOutbound: '↗ Ausgehend',
    customer: 'Kunde',
    ...
    va: {
      title: 'Virtueller Agent',
      callReason: 'Anrufgrund',
      handoffReason: 'Übergabegrund',
      containment: 'Zeit im Bot',
      agentJoined: 'Agent ist dem Anruf beigetreten',
    },
    wrapUp: {
      title: 'Nachbearbeitung',
      note: 'Agentennotiz',
...
const csDictionary = {
  ...
  customer: {
    ...
    search: {
      placeholder: 'Hledat podle e-mailu nebo telefonního čísla',
      button: 'Hledat',
      searching: 'Hledání…',
      clear: 'Vymazat hledání',
      prompt: 'Vyhledejte zákazníka podle e-mailu nebo telefonního čísla a zobrazte jeho profil 360°.',
      notFound: 'Pro „{{identity}}“ nebyl nalezen žádný zákazník.',
      error: 'Vyhledávání zákazníků je momentálně nedostupné.',
    },
  },
  case: {
  ...
  settings: {
    ...
    close: 'Zavřít',
    sla: {
      title: 'Akce při vypršení SLA',
      emailOnly: 'Platí pro e-mailové úkoly, které jste dosud nezapočali.',
      action: 'Když je dosaženo SLA',
      action_none: 'Žádná akce',
      action_offer: 'Nabídnout přeřazení',
      action_auto: 'Automaticky přeřadit',
      trigger: 'Spouštěč',
      trigger_imminent: 'V rámci prahu',
      trigger_expired: 'Po vypršení',
      queue: 'Přeřadit do (e-mail)',
      selectQueue: 'Vyberte frontu…',
      loadingQueues: 'Načítání front…',
      countdown: 'Automatické odpočítávání (sekundy)',
      wrapup: 'Důvod uzavření (automaticky)',
      selectWrapup: 'Vyberte důvod uzavření…',
    },
    focus: {
      title: 'Soustředění na prioritní práci',
      hint: 'Když se e-mail blíží svému SLA nebo jej překročí, nastaví vás na Nedostupný, aby vám nebyly přiřazovány nové úkoly, dokud jej nedokončíte. Po dokončení vás vrátí na Dostupný.',
      mode: 'Režim soustředění',
      on: 'Zap',
      off: 'Vyp',
  ...
  sla: {
    requeue: {
      autoCountdown: 'Přeřazení do {{queue}} za {{seconds}} s…',
      cancel: 'Ponechat úkol',
      offerTitle: 'SLA vyprší — přeřadit úkol?',
      offerMsg: 'Tento úkol dosáhl svého SLA a dosud jste jej nezapočali. Vyberte frontu pro přeřazení.',
      queueLabel: 'Fronta',
      selectQueue: 'Vyberte frontu…',
      dismiss: 'Ponechat úkol',
      confirm: 'Přeřadit',
    },
  },
  focus: {
    active: 'Režim soustředění: jste Nedostupní ({{reason}}), abyste mohli dokončit tento prioritní úkol.',
  ...
  email: {
    ...
    noCustomerEmail: 'Pro tohoto zákazníka není evidována e-mailová adresa.',
    subject: 'Předmět',
    from: 'Od',
    to: 'Komu',
    cc: 'Kopie',
    ...
    reply: {
      ...
      proofreadLabel: 'Zkontrolovat odpověď',
      toneLabel: 'Tón',
      ...
      proofread: {
        panelLabel: 'Kontrola odpovědi',
        found: 'Nalezeno {n} problém(ů)',
        noIssues: 'Žádné gramatické problémy',
        applyAll: 'Použít opravy',
        dismiss: 'Zavřít',
        accept: 'Přijmout',
        reject: 'Odmítnout',
        inlineCount: '{n} návrh(ů) v textu',
        coverage: {
          answers: 'Odpověď reaguje na zprávu zákazníka',
          incomplete: 'Odpověď nemusí zákazníkovi odpovědět úplně',
          missingLabel: 'Nevyřešeno',
          additionsLabel: 'Navržená doplnění',
          add: 'Vložit do odpovědi',
          added: 'Přidáno',
        },
        type: {
          grammar: 'Gramatika',
    ...
    wrapupSummary: {
      ...
      generate: 'Shrnutí dokončení',
      generating: 'Generuji shrnutí…',
      copy: 'Kopírovat',
      copied: 'Zkopírováno',
  ...
  history: {
    ...
    aiSummaryTitle: 'AI shrnutí',
    aiSummaryReason: 'Důvod',
    aiSummaryActions: 'Akce',
    aiSummaryNextSteps: 'Další kroky',
    aiSummaryAdditional: 'Dodatečné',
    aiSummaryVaTitle: 'Předání virtuálním agentem',
    aiSummaryVaCallReason: 'Důvod hovoru',
    aiSummaryVaHandoff: 'Důvod předání',
    aiSummaryVaContainment: 'Čas v botovi',
    aiSummaryWrapUpTitle: 'Vyhodnocení',
    aiSummaryWrapUpNote: 'Poznámka',
    ...
    variables: 'Proměnné',
    details: 'Detaily a diagnostika',
    interaction: 'interakce',
    range: 'Období',
    loading: 'Načítání…',
    biz: {
      customer: 'Zákazník',
      contactReason: 'Důvod kontaktu',
      ...
      wrapUp: 'Vyhodnocení',
      outcome: 'Výsledek',
      endReason: 'Důvod ukončení',
      terminationType: 'Ukončení',
      csat: 'CSAT',
      sentiment: 'Sentiment',
    },
    dataPanel: {
      details: 'Detaily',
      rawFields: 'Surová pole',
      caseDetailsNotAvailable: 'Detaily případu nejsou k dispozici v režimu Live',
    },
    eventType: {
      new: 'Nový',
  ...
  voice: {
    ...
    transcript: 'Přepis',
    transcriptLoading: 'Načítání přepisu…',
    transcriptUnavailable: 'Pro tento hovor zatím není přepis k dispozici.',
    transcriptLive: 'Tento hovor probíhá. Přepis bude k dispozici po jeho ukončení.',
    callsLoading: 'Načítání hovorů…',
    callsEmpty: 'Pro tohoto zákazníka nebyly nalezeny žádné hovory.',
    summaryLoading: 'Načítání souhrnu…',
    summaryUnavailable: 'Pro tento hovor zatím není souhrn k dispozici.',
    refresh: 'Obnovit přepis',
    live: 'ŽIVĚ',
    directionInbound: '↙ Příchozí',
    directionOutbound: '↗ Odchozí',
    customer: 'Zákazník',
    ...
    va: {
      title: 'Virtuální agent',
      callReason: 'Důvod hovoru',
      handoffReason: 'Důvod předání',
      containment: 'Čas v botovi',
      agentJoined: 'Agent se připojil k hovoru',
    },
    wrapUp: {
      title: 'Vyhodnocení',
